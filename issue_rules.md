...
+ [Подзадача](#подзадача)
  - [Рабочая область](#рабочая-область)
    ...
    - [Регистрационная карта](#регистрационная-карта-1)
...
## Глоссарий
### Документ
Запись в ПМ, в котором хранится информация.

### Регистрационная карта
Форма ввода информации в документ и ее отображения.
...
##### Числовой
Может содержать в себе любые числовые символы.

##### Дата и время
Может содержать в себе дату и/или время

##### Ссылочный
Содержит в себе URL ссылку на другой объект модели данных.
